...
func checkDelegationSignature(identity identity.SecretPermanentIdentity, trustchainPublicKey []byte) {
	signedData := append(
...
var _ = Describe("Identity", func() {
	const (
		goodSecretIdentity = ""
	...
	It("returns a tanker identity", func() {
		...
		Expect(err).To(Not(HaveOccurred()))
		identity := identity.SecretPermanentIdentity{}
	...
	It("returns a tanker public identity from a tanker identity", func() {
		...
		sidentity, err := base64.StdEncoding.DecodeString(b64Identity)
		Expect(err).To(Not(HaveOccurred()))
		publicIdentity := identity.PublicPermanentIdentity{}
	...
	It("parse a valid identity", func() {
		sidentity, err := base64.StdEncoding.DecodeString(goodSecretIdentity)
		Expect(err).To(Not(HaveOccurred()))
		id := identity.SecretPermanentIdentity{}
